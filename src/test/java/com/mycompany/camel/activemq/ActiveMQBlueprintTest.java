...
import com.redhat.cee.ldappoller.LdapPoller;
...
public class ActiveMQBlueprintTest extends CamelBlueprintTestSupport {    
	@EndpointInject(uri = "activemq:incomingOrders?username=admin&password=admin")
 ...
 /*
        ...
        LdapPoller generator = new LdapPoller();
